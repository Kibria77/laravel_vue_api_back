...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Unit Info</h4>
                    <hr/>
                    <form action="{{ route('unit-info-update', ['id' => $unit->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $unit->status == 0 ? 'checked' : '' }} name="status" type="radio" value="0">
