        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr/>
                    <form action="{{ route('brand-info-update', ['id' => $brand->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img src="{{ asset($brand->image) }}" alt="" height="50" width="150">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $brand->status == 0 ? 'checked' : '' }} name="status" type="radio" value="0">
                        ...
                        @foreach($brands as $brand)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('delete-brand', ['id' => $brand->id]) }}" method="POST" id="deleteCategory">
                                        @csrf
                                    </form>
                                </td>
                            </tr>
