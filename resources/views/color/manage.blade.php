...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Create A New Color</h4>
                    <hr/>
                    <form action="{{ route('color-store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" id="horizontal-firstname-input" placeholder="Color Name"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Color Code</label>
                            <div class="col-sm-9">
                                <input type="color" name="code" class="form-control" id="horizontal-firstname-input" placeholder="Color Code"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Color Description</label>
                            <div class="col-sm-9">
                                <textarea name="description" class="form-control" id="horizontal-email-input" placeholder="Color Description"></textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    <button type="submit" class="btn btn-primary w-md">Create A New Color</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">All Color Info Here</h4>
                    <hr/>
